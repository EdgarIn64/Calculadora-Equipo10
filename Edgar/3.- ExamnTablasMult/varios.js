...
var sValorCapturado="", sErr="", colorear;
	if (isNaN(sValor))
		...
		if (oTbl.rows.length>1){
			for (i=1; i<=10; i++){
				...
				colorear = document.getElementById("txtResultado"+i);
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						nCalif++;
						colorear.style.backgroundColor = "#50ff50";
					}
					else
						colorear.style.backgroundColor = "#ff5050";
				}
			}
		}
	}
