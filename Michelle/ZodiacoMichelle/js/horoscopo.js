...
function validaFechaMenor(campo){
    ...
    var borrarDiv=document.getElementsByTagName('div')[0];
    if(borrarDiv!=null)
    {
        console.log("Entro a borrar");
        padre=borrarDiv.parentNode;
        padre.removeChild(borrarDiv); 
    }
...
function creasigno(nDia,nMes){
    ...
    newDiv.style="border: 15px solid "+n+"; background-color:#9E04F0; text-align:center; font-family:georgia; font-size: 170%; width: 600px ;height:335px; margin:auto; margin-top: 15px;margin-bottom: 15px";
}
