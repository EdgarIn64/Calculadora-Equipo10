...
function ocultar(oc){
  lista=document.querySelectorAll('h2');
  if(lista.length!=0){
    i=lista.length-1;
    while(i>-1)
  ...
  para.innerHTML = "Calculadora " + oc;
  document.getElementById("titulo").appendChild(para);
  ...
  if(oc == "estandar"){
    ...
    document.getElementById("cientifica").style.display = "none"; 
  }
  else if(oc == "programador"){
    document.getElementById("programador").style.display = "block"; 
    document.getElementById("cientifica").style.display = "none"; 
  }
  else{
    document.getElementById("programador").style.display = "none"; 
    document.getElementById("cientifica").style.display = "block";
